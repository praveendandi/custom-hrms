<template>
    ...
    <ion-page>
        <ion-content :fullscreen="true">
            <FormView v-if="formFields.data" doctype="Compensatory Leave Request" v-model="compensatoryApplication"
...
const compensatoryApplication = ref({})
...
watch(
    () => [compensatoryApplication.value.from_date, compensatoryApplication.value.to_date],
    ([from_date, to_date]) => {
...
function validateForm() {
    compensatoryApplication.value.employee = employee.data.name
}
